        ...
        <v-list-item-content>
          ...
          <v-list-item-content class="py-0">
            <p class="mb-4">
              ...
              reason you missed it, here’s what I’d like to wish you all in the
              upcoming year.
            </p>
            <p class="mb-4">
              But before that, I want to thank you all for your photos here on
              Tookapic. Thank you for being part of this unique community. Thank
              you for your support, your subscriptions and your kind words in
        ...
        <v-list-item-content>
          <v-col class="pa-0">
            <v-textarea
              ...
              single-line
            />
            <b-button @click="post" elevation="0" rounded
      ...
      <v-slide-y-transition group>
        ...
        >
          <b-comment :comment="c.comment">
            ...
            <v-list-item v-for="(sc, x) in c.subcomments" :key="x" class="px-0">
              <v-list-item-avatar
                class="mr-2 my-0"
